...
public class PaymentController {
    ...
    public ResponseEntity<RedirectUrlDTO> pay(@RequestParam("productId") Long productId, @RequestParam("magazine") boolean magazine,
        ...
        try {
            redirectUrl = paymentService.pay(loggedUserData.getId(), productId, magazine, planId);
